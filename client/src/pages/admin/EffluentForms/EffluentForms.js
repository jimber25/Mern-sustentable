...
import { ListEffluentForms, EffluentForm } from "../../../components/Admin/EffluentForms";
...
export function EffluentForms() {
      ...
      render: () => (
        <Tab.Pane attached={false}>
         {siteSelected===null && (isMaster(role) || (isAdmin(role) && !site))? 
          ...
          <ListEffluentForms reload={reload} onReload={onReload} siteSelected={siteSelected} />
          : <ListEffluentForms reload={reload} onReload={onReload} /> 
          }
        </Tab.Pane>
      ),
    },
  ...
  return (
    ...
    // >
      ...
      <BasicModal show={showModal} close={onOpenCloseModal} title="Formulario Efluentes" size={"fullscreen"}>
        <EffluentForm onClose={onOpenCloseModal} onReload={onReload} />
      </BasicModal>
    </>
  );
}
